...
-type group_container_element() :: { 'name'|'group'|'members',
                                     binary()|em_group()|list(em_person()) }.

%% @doc Data structure generated by group_details/1,2
-type group_container() :: list(group_container_element()).
